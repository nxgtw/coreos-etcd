...
import (
	...
	"github.com/nxgtw/go.etcd.io/etcd/etcdserver/api/v3election"
	"github.com/nxgtw/go.etcd.io/etcd/etcdserver/api/v3election/v3electionpb"
	v3electiongw "github.com/nxgtw/go.etcd.io/etcd/etcdserver/api/v3election/v3electionpb/gw"
	"github.com/nxgtw/go.etcd.io/etcd/etcdserver/api/v3lock"
	"github.com/nxgtw/go.etcd.io/etcd/etcdserver/api/v3lock/v3lockpb"
	v3lockgw "github.com/nxgtw/go.etcd.io/etcd/etcdserver/api/v3lock/v3lockpb/gw"
	"github.com/nxgtw/go.etcd.io/etcd/etcdserver/api/v3rpc"
	etcdservergw "github.com/nxgtw/go.etcd.io/etcd/etcdserver/etcdserverpb/gw"
	"github.com/nxgtw/go.etcd.io/etcd/pkg/debugutil"
	"github.com/nxgtw/go.etcd.io/etcd/pkg/httputil"
