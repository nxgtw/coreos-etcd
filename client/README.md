...
[![GoDoc](https://godoc.org/github.com/nxgtw/go.etcd.io/etcd/client?status.png)](https://godoc.org/github.com/nxgtw/go.etcd.io/etcd/client)
...
```bash
go get github.com/nxgtw/go.etcd.io/etcd/client
```
