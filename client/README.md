...
[![GoDoc](https://godoc.org/github.com/nxgtw/dp-etcd/client?status.png)](https://godoc.org/github.com/nxgtw/dp-etcd/client)
...
```bash
go get github.com/nxgtw/dp-etcd/client
```
