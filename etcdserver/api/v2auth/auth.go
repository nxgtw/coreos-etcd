...
import (
	...
	"github.com/nxgtw/dp-etcd/etcdserver/api/v2error"
	"github.com/nxgtw/dp-etcd/etcdserver/etcdserverpb"
...
var (
	plog = capnslog.NewPackageLogger("github.com/nxgtw/dp-etcd", "etcdserver/auth")
)
