...
import (
	...
	"github.com/nxgtw/go.etcd.io/etcd/etcdserver/api/v2error"
	"github.com/nxgtw/go.etcd.io/etcd/etcdserver/etcdserverpb"
...
var (
	plog = capnslog.NewPackageLogger("github.com/nxgtw/go.etcd.io/etcd", "etcdserver/auth")
)
