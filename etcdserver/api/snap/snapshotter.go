...
import (
	...
	"github.com/nxgtw/go.etcd.io/etcd/etcdserver/api/snap/snappb"
	pioutil "github.com/nxgtw/go.etcd.io/etcd/pkg/ioutil"
...
var (
	plog = capnslog.NewPackageLogger("github.com/nxgtw/go.etcd.io/etcd", "snap")
