...
import (
	...
	"github.com/nxgtw/dp-etcd/etcdserver/api/snap/snappb"
	pioutil "github.com/nxgtw/dp-etcd/pkg/ioutil"
...
var (
	plog = capnslog.NewPackageLogger("github.com/nxgtw/dp-etcd", "snap")
